...
(async()=>{const browser=await chromium.launch({channel:'chrome',headless:true});try{
 ...
 assert.ok(await page.locator('.pr-price-point').count()<=7);
 ...
 console.log('PASS right results panel, larger text, actual map click selects matching resident, 84-cell comparison, location pills, four color modes, readable persona and mobile bounds');
